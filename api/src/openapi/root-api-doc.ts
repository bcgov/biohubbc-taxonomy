...
export const rootAPIDoc = {
  ...
  servers: [
    ...
    {
      url: 'https://api-dev-biohubbc-taxonomy.apps.silver.devops.gov.bc.ca',
      description: 'deployed api in dev environment'
    },
    {
      url: 'https://api-test-biohubbc-taxonomy.apps.silver.devops.gov.bc.ca',
      description: 'deployed api in test environment'
    },
    {
      url: 'https://api-biohubbc-taxonomy.apps.silver.devops.gov.bc.ca',
