...
- To provide a single source for taxonomic data in BC.
- To provide support for meta information about taxonomy, like First Nations species names.
- To reduce the effort involved with managing the taxonomy data.
- To improve access for all stakeholders to a single source truth for taxonomic data in BC.
