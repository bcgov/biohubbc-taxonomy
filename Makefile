...
## - Builds all of the biohub taxonomy projects (db, db_setup, api, app)
## ------------------------------------------------------------------------------
...
## - Builds all of the biohub taxonomy backend projects (db, db_setup, api)
## ------------------------------------------------------------------------------
...
## ------------------------------------------------------------------------------
## Build/Run Backend Commands
## - Builds all of the biohub taxonomy backend projects (db, db_setup)
## ------------------------------------------------------------------------------
...
## - Builds all of the biohub taxonomy backend+web projects (db, db_setup, api, app)
## ------------------------------------------------------------------------------
...
database: ## Executes into database container.
	...
	@docker-compose exec db psql -U $(DB_ADMIN) -p $(DB_PORT) -d $(DB_DATABASE)
